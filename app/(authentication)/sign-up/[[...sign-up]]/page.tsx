...
export default function SignUpPage() {
  return (
    <div className="min-h-screen grid w-full items-center bg-zinc-900 px-4 font-game text-sm text-white">
      <SignUp.Root>
        <SignUp.Step
          name="start"
        ...
        >
          <header className="text-center">
            ...
            <h1 className="mt-3 text-base font-bold fontga tracking-wide text-yellow-400 uppercase">
              Create Account
            </h1>
          </header>
